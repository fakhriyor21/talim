...
const moduleBlueprints: ModuleBlueprint[] = [
  ...
  },
  {
    ...
    templatesByGrade: {
      7: ["O‘simlik hayot sikli", "Tuproq turlari", "Namlik tushunchasi", "Oddiy sug‘orish", "Urug‘ tanlash", "Ekish oralig‘i", "Fotosintez kirish", "Yorug‘lik ta’siri", "Mini issiqxona", "Harorat nazorati", "Suv tejash kirish", "Organik o‘g‘it kirish", "O‘simlik kasalligi kirish", "Zararkunanda kirish", "Agro xavfsizlik", "Mehnat gigiyenasi", "Hosil kuzatuvi", "Vegetatsiya kundaligi", "Bog‘dorchilik amaliyoti", "Qishloq xo‘jalik asboblari", "Agro ekologiya", "Mahalliy ekinlar", "Kompost tayyorlash", "Ko‘chat parvarishi", "Mulchalash asoslari", "Dala kundaligi raqamlashtirish", "Suv sarfi hisoblash", "Yakuniy amaliy topshiriq", "7-sinf agro loyiha", "7-sinf agro hackathon"],
      8: ["Tuproq tarkibi analiz", "pH va tuproq", "Namlik sensori", "Tomchilatib sug‘orish", "Suv balansi", "O‘g‘itlash jadvali", "NPK kirish", "Iqlim monitoringi", "Issiqxona boshqaruvi", "Ventilyatsiya", "Kasallik belgilari", "Zararkunanda tahlili", "Biologik himoya", "Agro texnika parvarishi", "Hosildorlik ko‘rsatkichi", "Ma’lumot kiritish", "Agro xarita kirish", "Fermer kundaligi", "Sifat nazorati", "Saqlash sharoiti", "Mahsulot saralash", "Statistik tahlil kirish", "ET0 kirish", "Fertigatsiya amaliyoti", "Sensor kalibrovkasi", "Dron xavfsizligi", "Mini dala eksperimenti", "Mini loyiha", "8-sinf agro yakuniy", "8-sinf agro demo day"],
      9: ["Aniq dehqonchilik kirish", "Agro-sensor tarmog‘i", "Iqlim modeli", "Evapotranspiratsiya", "Sug‘orish algoritmi", "Issiqxona avtomatika", "CO2 monitoring", "Yorug‘lik boshqaruvi", "Nutrient management", "Kasallik diagnostika", "Image-based monitoring", "Dron kirish", "NDVI tushunchasi", "Hosil prognozi", "Risk tahlili", "Agro iqtisodiyot kirish", "Resurs optimizatsiya", "Agro ma’lumotlar bazasi", "Dashboard yaratish", "Sifat audit", "Loyiha hujjati", "Jamoaviy dala amaliyoti", "Geo-tagging", "Qator oralig‘i optimizatsiyasi", "Mikroiqlim zonalari", "Stress indeksi tahlili", "Agro IoT telemetriya", "9-sinf agro loyiha", "Capstone demo", "9-sinf agro challenge"],
      10: ["Agrotexnika tizimlari", "Precision irrigation", "IoT integratsiya", "Weather API ulash", "Yield modeling", "Soil analytics", "Disease classification", "Remote sensing", "Agro dron marshrut", "Pest prediction", "Greenhouse digital twin", "Energy-water nexus", "Supply chain basics", "Post-harvest analytics", "Quality metrics", "Experiment design", "A/B dala tajribasi", "Monitoring protokoli", "Data cleaning", "Forecast validation", "Agro AI kirish", "Samaradorlik KPI", "VRA (variable-rate application)", "GIS qatlamlari integratsiyasi", "Mavsumiy risk xaritasi", "Sensor nosozligini aniqlash", "Agro BI dashboard", "10-sinf tadqiqot", "Yakuniy hisobot", "10-sinf agro pilot"],
      11: ["Sustainable agriculture", "Climate-smart farming", "Carbon footprint", "Water governance", "Soil regeneration", "Advanced fertigation", "AI crop advisor", "Computer vision agronomy", "Drone analytics", "Satellite data fusion", "Econometric agro model", "Risk mitigation", "Insurance analytics", "Policy and regulation", "Food safety standards", "Traceability systems", "Agro startup model", "Investment pitch", "Field experiment advanced", "Scientific writing", "Research ethics", "Capstone planning", "Pilot implementation", "Agro data governance", "MRV tizimi (monitoring-reporting-verification)", "Katta dala optimizatsiyasi", "Resilience stress-test", "KPI benchmark platformasi", "11-sinf agro capstone", "11-sinf agro innovation summit"],
    },
  },
  {
    id: "energiya",
